 ...
 */
	Configure::write('Security.salt', 'jmajorsDYhG93b0qyJfIxfs2guVoUubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76859309659876543217453542496749683645');
