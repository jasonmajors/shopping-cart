...
<table class='table'>
	...
	<?php foreach ($orders as $order): ?>
		...
		<td><?php echo $order['User']['firstname'] . ' ' . $order['User']['lastname'] . '<br>' . $order['Order']['shipping_address'] . '<br>' . $order['Order']['shipping_city'] .  ', ' . $order['Order']['shipping_state'] . ' ' . $order['Order']['shipping_zipcode']; ?></td>
