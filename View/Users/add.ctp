...
<fieldset>
	...
	<?php 	
		...
		echo $this->Form->input('address', array('label' => 'Street Address', 'class' => 'form-control'));
		echo $this->Form->input('city', array('label' => 'City', 'class' => 'form-control'));
		echo $this->Form->input('state', array('label' => 'State', 'class' => 'form-control'));
		echo $this->Form->input('zipcode', array('label' => 'Zipcode', 'class' => 'form-control'));
